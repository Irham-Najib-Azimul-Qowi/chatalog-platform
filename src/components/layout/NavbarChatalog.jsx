  ...
  return (
    ...
    <header className="bg-[#006064] text-white shadow-md sticky top-0 z-40">
      <nav className="container mx-auto flex justify-between items-center p-4 px-6">
        ...
        {/* Kanan: Tombol Aksi */}
        <div>
          {/* Jika user login (Super Admin/Admin Toko), jangan tampilkan tombol Login */}
          {!currentUser ? (
            <Link 
              to="/login" 
            ...
            // Jika sudah login, kita bisa tampilkan tombol 'Dashboard'
            // atau biarkan kosong (karena Admin Bar akan muncul)
            <span className="text-sm">Selamat Datang!</span> // Placeholder
          )}
        </div>
      </nav>
    </header>
